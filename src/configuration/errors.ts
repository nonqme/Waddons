export const ERROR_MESSAGES = {
  API_KEY_IS_REQUIRED: 'apiKey is required',
  ...
  PATH_MUST_BE_A_STRING: 'path must be a string',
  ...
  CONFIGURATION_NOT_FOUND: 'Configuration not found, please use create first',
};
